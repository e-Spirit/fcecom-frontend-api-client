...
import { EventHandler, initProductHandlers } from './core/modules/eventHandlers/EventHandler';
...
export const initEventHandlers = (api: EcomFSXAProxyApi, regExpMap?: RegExpMap): Array<EventHandler> | void => {
  let result;
  if (PreviewDecider.isBrowserEnvironment()) {
    result = [...initProductHandlers(api, regExpMap?.productUrlPattern)];
  }
  return result;
};
